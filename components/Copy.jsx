  ...
  return (
    <Container>
        <div className="md:w-4/5 md:-ml-12 flex flex-col justify-around items-start gap-2 lg:gap-6">
            ...
            <h3 className="text-secondary drop-shadow-lg text-xl lg:text-3xl font-bold">Generate quality referral pitches and cover letters in less than 30 seconds using AI magic!</h3>
